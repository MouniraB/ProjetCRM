		...
		<table id="MyStretchGrid"
			...
			<thead>
				...
				<tr>
					...
					<th class="sortable">Entreprise</th>
					<th class="sortable">Edit</th>
					<th class="sortable">Supprimer</th>
					<th class="sortable">Ajouter échange </th>
			...
			<tbody>
				<s:iterator value="contacts">
					<tr>
						...
						<td><s:url action="initAddEchangeAction" var="urlAddEchange">
								<s:param name="id">
									<s:property value="id" />
								</s:param>
							</s:url><a href="${urlAddEchange }"><i class="icon-plus-sign"></i></a></td>
					</tr>
				</s:iterator>
				<tr>
					<td><a href="initAddAction" class="btn btn-white">Nouveau</a></td>
				</tr>
